        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-400 max-w-xs">
              The UAE&apos;s premier car buyout service with instant payments. 
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-400">info@carvault.ae</span>
              </div>
              <div className="flex items-center gap-3">
        ...
        <div className="border-t border-trim-silver/20 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-wrap items-center gap-4 text-xs text-slate-400">
              <span>© 2024 CarVault UAE. All rights reserved.</span>
              <div className="flex flex-wrap gap-4">
                <a href="/terms" className="hover:text-pearl transition-colors">
                  Terms of Service
                </a>
                <a href="/privacy" className="hover:text-pearl transition-colors">
                  Privacy Policy
                </a>
                <a href="/cookies" className="hover:text-pearl transition-colors">
                  Cookie Policy
                </a>
                <a href="/kyc-aml" className="hover:text-pearl transition-colors">
                  KYC/AML
                </a>
                <a href="/inspection" className="hover:text-pearl transition-colors">
                  Inspection Policy
                </a>
                <a href="/complaints" className="hover:text-pearl transition-colors">
                  Complaints
                </a>
              </div>
            </div>
