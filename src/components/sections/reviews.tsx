...
const reviews: Review[] = [
  {
    ...
    amount: "AED 180,000",
    paymentAmount: "AED 180,000",
    avatar: "AH",
    problem: "Needed quick sale, dealers were slow and lowballing.",
    solution: "CarVault: instant valuation, same-day payment via bank transfer."
  },
  {
    id: 2,
    name: "Sarah Johnson",
    ...
    rating: 5,
    text: "Quick online inspection and instant payout. Real market price, no haggling.",
    carModel: "2020 Mercedes C-Class",
    amount: "AED 95,000",
    paymentAmount: "AED 95,000",
    avatar: "SJ",
    problem: "Worried about scams and lowballing from dealers.",
    solution: "CarVault: transparent process, fair price, secure payment."
  },
  {
    id: 3,
    ...
    rating: 5,
    text: "Outstanding service! They handled all the paperwork and gave me 15% more than other dealers offered. The instant bank transfer payment option is a game-changer for someone like me who prefers digital payments.",
    carModel: "2018 Toyota Camry",
    amount: "AED 65,000",
    paymentAmount: "AED 65,000",
    avatar: "MH",
    problem: "Dealers offered 15% less, complex paperwork, wanted instant payment.",
    solution: "CarVault: 15% more, handled paperwork, bank transfer to account."
  },
  {
    id: 4,
    name: "Priya Patel",
  ...
  },
  {
    ...
    location: "Ajman, UAE",
    rating: 5,
    text: "I've sold cars before, but never this easy. CarVault's online valuation was spot-on, and getting paid via bank transfer was exactly what I wanted. They even helped with the transfer documentation.",
    carModel: "2017 Audi A4",
    amount: "AED 75,000",
    paymentAmount: "AED 75,000",
    avatar: "DW",
    problem: "Previous sales: multiple visits, negotiations, delayed payments, wanted instant payment.",
    solution: "CarVault: streamlined process, bank transfer payment, full documentation."
  },
  {
    id: 6,
    ...
    rating: 5,
    text: "Excellent experience from start to finish. The team was knowledgeable, the price was competitive, and receiving payment via bank transfer was convenient. I'll definitely use CarVault again when I need to sell another car.",
    carModel: "2019 Nissan Altima",
    amount: "AED 55,000",
    paymentAmount: "AED 55,000",
    avatar: "FA",
    problem: "Living in RAK, hard to find reliable buyers, local dealers low prices.",
    solution: "CarVault: nationwide service, competitive pricing, bank transfer payment."
  }
];
