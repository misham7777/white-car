...
const premiumPrice = 54000;
const savings = premiumPrice - marketPrice;
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            Traditional dealerships offer market rates. We offer market rates plus premium.
          </p>
        </motion.div>
          ...
          >
            <Card className="relative h-full bg-asphalt border-desert-gold/30 overflow-hidden">
              ...
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-pearl">Premium Service</CardTitle>
                <p className="text-slate-400 text-sm">Our exclusive premium payout</p>
              </CardHeader>
              <CardContent className="text-center space-y-6">
                <div>
