...
const steps = [
  ...
  },
  {
    ...
    description: "Our AI analyzes market data and provides a fair offer.",
    time: "Instant",
    color: "desert-gold"
  },
  {
  ...
  },
  {
    ...
    description: "Get paid instantly via bank transfer or cash.",
    time: "Immediate",
    color: "taillight-red"
  }
];
          ...
          <Card className="max-w-2xl mx-auto bg-carbon border-trim-silver/20">
            <CardContent className="p-8">
              ...
              <p className="text-slate-400 mb-6">
                Join thousands of satisfied customers who got more for their cars with instant payment.
              </p>
