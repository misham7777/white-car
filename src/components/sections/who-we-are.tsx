    ...
    >
      ...
      >
        ...
        <div className="lg:col-span-6">
          ...
          >
            Dubai-based, 15 years buying premium cars. We buy direct (no middleman), price at real market value, and settle same day—bank transfer or cash. Paperwork handled across all emirates. We offer full online inspection so you never need to visit a branch.
          </motion.p>
          ...
          >
            ...
            <div className="flex items-center gap-4 rounded-2xl bg-asphalt/60 ring-1 ring-trim-silver/15 p-4 md:p-5">
              ...
              <div>
                <div className="text-base md:text-lg font-semibold text-pearl">Instant Payout</div>
                <div className="text-xs md:text-sm leading-tight opacity-70 text-slate-400">Bank transfer or cash.</div>
              </div>
            </div>
