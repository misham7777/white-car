  ...
  const faqItems = [
    {
      ...
      answer: 'With CarVault, you can sell your car in as little as 2 hours! Our process includes instant online valuation, same-day inspection, and immediate payment via bank transfer or cash. Most transactions are completed within 24 hours.',
    },
    {
      id: 'item-2',
      question: 'What payment methods do you accept?',
      answer: 'We accept multiple payment methods including bank transfer and cash payments. Bank transfers are processed instantly to your account, while cash payments are available for same-day transactions.',
    },
    {
      id: 'item-3',
